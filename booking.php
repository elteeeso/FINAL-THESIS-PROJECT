...
if (isset($_POST['submit'])) {
    ...
    if ($appdate <= $cdate) {
        ...
        $sql = "insert into tblappointment(user_id,AppointmentNumber,Name,MobileNumber,Email,AppointmentDate,AppointmentTime,Specialization,Doctor,Message)values(:userId,:aptnumber,:name,:mobnum,:email,:appdate,:aaptime,:specialization,:doctorlist,:message)";
                        ...
                        <div class="booking-form">
                            ...
                            <form role="form" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <input type="number" name="aptnumber" id="aptnumber" class="form-control" placeholder="Appointment Number" maxlength="10">
                                    </div>
